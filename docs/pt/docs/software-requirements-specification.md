...
A elicitação de requisitos foi realizada, principalmente, com conversas com pessoas envolvidas na área de sustentabilidade, juntamente de um questionário de elicitação que, no momento da última alteração neste documento (20/01/2025) contava com 20 respostas.
...
#### Registrar e manter ações conjuntas
  ...
  - **Confirmação:**
      - [x] Existe uma tela onde um usuário cria uma ação conjunta com imagem de capa, mome, descrição, objetivo, data e hora de início, data e hora de encerramento, aceitação de voluntários e número máximo de participantes
      - [x] Existe uma tela para visualizar e editar os detalhes de uma ação conjunta já criada
...
#### Juntar-se a ação conjunta
  ...
  - **Confirmação:**
      - [x] Existe uma tela para pesquisar todas as ações conjuntas, filtrando por nome, data de início e fim e se estão concluídas ou não
      - [x] Existe uma tela onde todos os usuários podem visualizar os detalhes de uma ação
